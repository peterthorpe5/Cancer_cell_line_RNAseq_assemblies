...
cp ./MCF7_GG_Trinity/Trinity-GG.fasta ./MCF7_GG.fasta
TransDecoder.LongOrfs -t MCF7_GG.fasta
diamond blastp --query ./*/longest_orfs.pep --db /gpfs1/scratch/bioinf/db/databases/uniprot.dmnd --threads 8 --max-target-seqs 1 --outfmt 6 -o blastp.outfmt6
TransDecoder.Predict -t MCF7_GG.fasta --retain_blastp_hits blastp.outfmt6
