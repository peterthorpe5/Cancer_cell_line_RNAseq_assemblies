...
cp ./ZR75B_GG_Trinity/Trinity-GG.fasta ./ZR75B_GG.fasta
TransDecoder.LongOrfs -t ZR75B_GG.fasta
diamond blastp --query ./*/longest_orfs.pep --db /gpfs1/scratch/bioinf/db/databases/uniprot.dmnd --threads 8 --max-target-seqs 1 --outfmt 6 -o blastp.outfmt6
TransDecoder.Predict -t ZR75B_GG.fasta --retain_blastp_hits blastp.outfmt6
