...
for entry in info_table:
    ...
    f_out.write("python /home/pjt6/scratch/cancer_genomes/seq2hla/seq2HLA/seq2HLA.py -1 /gpfs1/scratch/bioinf/pjt6/cancer_genomes/seq2hla/%s_paired_1.fq -2 /gpfs1/scratch/bioinf/pjt6/cancer_genomes/seq2hla/%s_paired_2.fq -r %s_trimmed -p 16 \n" % (cell_line,cell_line, cell_line))
