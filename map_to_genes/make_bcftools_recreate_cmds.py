...
for entry in info_table:
    ...
    conda = "conda activate bcftools\n"
    f_out.write(conda)
    # freebayes
    bccmd = "bcftools consensus -s unknown -H 1 -f ../Homo_sapiens.GRCh38.cds.all.fa  %s_vs_genes.vcf.gz > %s_H1_SNPs_reconstruct.fasta\n" % (cell_line, cell_line)
    # print(bccmd)
    f_out.write(bccmd)
